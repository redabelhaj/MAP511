...
class PPO:
    ...
    """
    def __init__(self, size,name, hunger = 120, walls = True,n_iter = 500, batch_size = 32,dist_bonus = .1,gamma = .99, n_epochs=5, eps=.2, target_kl=1e-2, seed=-1, rs = 'none', use_entropy = False,beta = 1e-2):
...
if __name__ == "__main__":
    size = (12, 12)
    # size, 'ppo_classic_test', hunger=25, n_iter=1000, batch_size=30,seed = 10, beta=1, use_entropy=False, rs = 'none'
    ppo = PPO(size, 'debug', hunger=25, n_iter=10000, batch_size=30,seed = 10, beta=1, use_entropy=False, rs = 'none')
    bs = ppo.batch_size
    best_reward = -1
    best_length = 0
